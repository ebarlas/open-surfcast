...
/**
 * RecyclerView adapter for the tide station catalog.
 * <p>
 * Shows all stations with a checkmark for stations already added
 * to the user's preferred list. Supports click-to-toggle.
 */
public class TideCatalogAdapter extends RecyclerView.Adapter<TideCatalogAdapter.ViewHolder> {

    /**
     * Callback for station toggle events.
     */
    public interface OnStationToggleListener {
        void onStationToggled(TideStation station, boolean added);
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(TideStation station, boolean isAdded) {
